...
result_urls = result_monkey + result_dog + result_duck + result_nananana + result_money * 10 + result_oyaji * 15 + result_seabiscuit + result_momu + result_mam + result_sana + result_chihiro
